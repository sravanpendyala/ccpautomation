...
public class ApiGatewayCaller extends AmazonWebServiceClient {
    ...
    public ApiGatewayCaller(String accessKey, String secretAccessKey, String apiKey, String region, URI endpoint) {
    ...
    public ApiGatewayResponse execute(HttpMethodName method, String resourcePath, String contentType, InputStream content) {
        final ExecutionContext executionContext = createExecutionContext();

        DefaultRequest request = prepareRequest(method, resourcePath, contentType, content);
    ...
    private DefaultRequest prepareRequest(HttpMethodName method, String resourcePath, String contentType, InputStream content) {
        DefaultRequest request = new DefaultRequest(API_GATEWAY_SERVICE_NAME);
        request.setHttpMethod(method);
        request.setContent(content);
        request.setEndpoint(this.endpoint);
        request.setResourcePath(resourcePath);
        request.setHeaders(Collections.singletonMap("Content-type", contentType));
        return request;
    }
